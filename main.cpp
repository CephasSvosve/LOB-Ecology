...
double shares_outstanding = 0.4*market_wealth/300;
double market_cash = 0.6*market_wealth;
...
for(auto &[k,v] : market.tradeable_assets()){
    myfile<<watch.current_time()<<","<<(get<1>(v.get_price())+get<2>(v.get_price()))/2.<<",";
